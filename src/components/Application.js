      ...
      <div className="col">
        <div className="card card-registration my-4">
          <div className="row g-0">
            <div className="col-xl-6 d-none d-xl-block VAppImg">
            ...
            <div className="col-xl-6">
              <div className="card-body p-md-5 text-black">
                ...
                <div className="row">
                  <div className="col-md-6 mb-4">
                    <div className="form-outline">
                      ...
                      <label className="form-label" htmlFor="form3Example1m1">Martial Status</label>
                    </div>
                  </div>
                  <div className="col-md-6 mb-4">
                    <div className="form-outline">
                ...
                <div className="form-outline mb-4">
                  ...
                  <label className="form-label" htmlFor="form3Example8">Current Address</label>
                </div>
                <div className="form-outline mb-4">
                  <input  style={{border:"1px solid black"}} type="text" id="form3Example8" className="form-control form-control-lg" />
                  <label className="form-label" htmlFor="form3Example8">Permanent Address</label>
                </div>
                <div className="form-outline mb-4">
                  <input  style={{border:"1px solid black"}} type="text" id="form3Example8" className="form-control form-control-lg" />
                  <label className="form-label" htmlFor="form3Example8">Near Famous Location</label>
                </div>
              ...
              <Link to="/coninfo"> <button type="button" className="btn btn-primary btn-lg ms-2">Save & Next</button>
                 </Link> </div>
